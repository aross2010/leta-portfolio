    ...
    >
      <div className="relative md:mb-6 mb-3 w-full flex md:flex-row flex-col items-center justify-center">
        ...
        <motion.h2
          ...
          className="md:hidden uppercase tracking-wider font-medium text-3xl mt-6"
        >
          {name}
        </motion.h2>
        <motion.h2
          ...
          className="md:hidden uppercase tracking-wider font-medium text-gray-600 mt-2"
        >
          {titleLong}
        </motion.h2>
